...
def run():
  ...
  image_options = {'resize': True,'image_height': 224, 'image_width': 224}
  train_dataset_reader = dataset.BatchDatset("data/train.txt", image_options)
  val_dataset_reader = dataset.BatchDatset("data/val.txt", image_options)

  train_data, train_labels = train_dataset_reader.get_records()
  test_data, test_labels = val_dataset_reader.get_records()
  data = { 'train_data': train_data,
      'train_labels': train_labels,
      'test_data': test_data,
      'test_labels': test_labels }
  run_model(data, image_dim, 1, 40)
